...
const RISK_COLOR: Record<string, string> = {
  low: '#49C788', medium: '#f97316', high: '#ff4444',
};
...
export default function AdminUsers() {
  ...
  const changeRole = (userId: string, currentRole: string) => {
    const options = ROLES
      ...
      .map(r => ({ text: r.charAt(0).toUpperCase() + r.slice(1), onPress: () => confirmRoleChange(userId, r) }));
    Alert.alert('Change Role', `Current: ${currentRole}`, [
      ...options,
...
const styles = StyleSheet.create({
  ...
  filterChipActive:     { backgroundColor: 'rgba(73,199,136,0.12)', borderColor: '#49C788' },
  filterChipText:       { color: '#888', fontSize: 12, fontWeight: '500', textTransform: 'capitalize' },
  filterChipTextActive: { color: '#49C788' },
  ...
  avatarText:           { color: '#49C788', fontWeight: '700', fontSize: 15 },
